...
\title{Reverse Jigsaw group A} % transitive, verb-derived, cause O to be V-ed, relating causing and caused events
...
\section{Romance}
Here's the same pattern again, with French `make':

\pex
    \a \begingl
        \gla \rightcomment{[French]}Marie  fit  reparer  la  voiture  //
        \glb Marie made repair the car//
        \glft `Marie got the car fixed.'//
    \endgl
    \a \begingl
        \gla \rightcomment{[Italian]}Maria  fece  riparare  la  macchina  //
        \glb Maria made repair the car //
        \glft `Maria got the car fixed.'//
    \endgl
    \a \begingl
        \gla \rightcomment{[Spanish]}Maria  hizo  arreglar  el  coche //
        \glb Maria made repair the car //
        \glft `Maria got the car fixed.'//
    \endgl
\xe
...
And what do you think about these possibilities in English?
