...
\title{Jigsaw group B} % transitive, verb-derived, cause O to be V-ed, relating causing and caused events
...
\pex
    ...
    \endgl
    \a \begingl
        \gla teo hekri et ha-sefer le-noni//
        \glb Theo read.\gsc{PAST}-\gsc{CAUS} \gsc{ACC} the-book to-Noni//
        \glft `Theo read the book out to Noni.'//
    \endgl
\xe
\pex
    \a \begingl
