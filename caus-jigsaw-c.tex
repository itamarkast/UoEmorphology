...
\title{Jigsaw group C} % complex events, VoiceP-derived, cause O to V
...
In this expert group, see if you can find out what is being caused, and to what/whom.
...
\pex
    \a \begingl
        \gla teo lavaʃ et ha-taxposet//
        \glb Theo wore-\gsc{PAST} \gsc{ACC} the-costume//
        \glft `Theo wore the costume.'//
    \endgl
    \a \begingl
        \gla adam helbiʃ et teo be-taxposet ʃel totoro//
        \glb Adam wore.\gsc{CAUS-\gsc{PAST}} \gsc{ACC} Theo in-costume of Totoro//
        \glft `Adam dressed Theo in a Totoro costume.'//
    \endgl
\xe
\pex
    \a \begingl
