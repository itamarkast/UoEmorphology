...
What allomorphy is happening here? What is being \textbf{conditioned} by what? % syntactic, outward-looking
...
Similar phenomenon for Applicatives in Georgian, here with the verb \emph{rbina} `run':
\pex 
