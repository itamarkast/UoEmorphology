...
\hfill \emph{Morphology 2023-24, Edinburgh, Handout 1}
\bigskip
...
Here, \gsc{rep}etitive means `again'. Assume that one of the following means `make someone learn' and one means `teach' - which is which?
