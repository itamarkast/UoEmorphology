...
\hfill \emph{Morphology 2024-25, Edinburgh, Exercise 1}
\bigskip
...
\bigskip
What can you say about the relationship of each element with the others? Is there some logic that tells us what the order should be?
...
Try to draw a syntactic tree for~(\lastx a), based on whatever you've learned about syntax at this point. It doesn't need to be too fancy - we don't need any movement, for example, or very elaborate labels for different nodes; just an idea of what the different heads or phrases are and where they originate more or less. The important thing here is not to get the tree ``right'' but to have a starting point for discussion in the next class.
...
Now let's do the same thing for Latin (which has ``theme vowels'' that you can ignore). First, evaluate how the affixes are arranged: what determines their order? Then consider how the order in Latin compares with the order in English.
\pex
    \a \begingl
        \gla am-\=a-ve-ra-m//
        \glb love-\gsc{THEME}-Perf-Past-1\gsc{SG}//
        \glft `I had loved'//
        \endgl
    \a \begingl
        \gla am-\=a-ve-r-\=o//
        \glb love-\gsc{THEME}-Perf-Fut-\gsc{1SG}//
...
% \end{itemize}
\vspace{2cm}
If you want to, try to draw a tree of some kind for Latin as well.
