...
Nous allons examiner maintenant un autre ensemble de données qui peuvent aussi être expliquées par les théories constructionnelles.
...
Généralisations de Bobaljik 2012:
