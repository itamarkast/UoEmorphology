...
\pex[exno=49]
    \a \begingl
        ...
        \glft `J'ai fait en sorte que Mwape et Mutumba se voient l'un l'autre.'//
        \endgl
    \a \begingl
...
À quoi ressemblerait cette langue  (\emph{bemba}) si elle avait des préfixes plutôt que des suffixes, et pourquoi? 

\begin{answer}{
\pex
    \a \midline{} ya - an - mon
    \a \midline{}  ana - eshy - mon
\xe
}
\end{answer}
...
Quelles phrases du Yupik correspondent à quelles phrases du français et pourquoi?
...
\begin{itemize}
    ...
    \item Le fait qu'une même phrase peut exprimer une portée sémantique différente montre déjà que le tableau ci-desssus est simplifié: parfois, l'ordre syntaxique ne reflète pas la hiérarchie sémantique (mais celle-ci est reflétée dans la hiérarchie syntaxique).
