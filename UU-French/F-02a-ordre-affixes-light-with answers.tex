...
\pex
    \a \begingl
        \gla am-\=a-ve-ra-m//
        \glb \root{AIM}-\gsc{THÈME}-Parfait-Passé-1\gsc{SG}//
        \glft `J'ai eu aimé'//
        \endgl
    \a \begingl
        \gla am-\=a-ve-r-\=o//
        \glb \root{AIM}-\gsc{THÈME}-Parfait-Fut-1SG//
...
En quoi cela est-il différent du français?
 ...
 V < Th < Parfait < T.
 \begin{itemize} \tightlist
     \item $\approx$ T > Parfait > V.
     \item C'est comme en français, mais \textbf{dans la syntaxe en français} et \textbf{dans la morphologie en latin}.  
