...
\hfill \emph{Morphology 2024-25, Edinburgh, Handout 6}
\bigskip
...
\begin{enumerate}
    \item Look at the arguments a predicate takes.
    \item Establish a formal system for subjects and objects.
    \item Identify different parts of the structure using adverbs.
    \item Compare how all this is expressed syntactically with how it's expressed morphologically.
\end{enumerate}
...
% Comment out to fit everything on 4pp:
\begin{answer}{
