...
\title{Reverse jigsaw group C} % lexical, unpredictable transitive meaning, root-derived
...
Like with Japanese above, is there a way to characterize the relationship between the simple verb and the causative verb in the following examples?
