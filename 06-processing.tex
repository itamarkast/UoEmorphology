...
\begin{block}{\alert<1>{\textbf{Lexical decision}}}
	\begin{itemize} \tightlist
		\item Response Time $\sim$ frequency.
		\item Error rate $\sim$ frequency.
		\item The strongest, most robust measure we have.
...
\frame{
	...
	Where is -\emph{able} more frequent?
...
%	\scriptsize
	\tiny
	\bibliographystyle{/users/ikastner/Edi/linquiry2}
	\bibliography{/users/ikastner/Edi/lingxbib}
\end{frame}
