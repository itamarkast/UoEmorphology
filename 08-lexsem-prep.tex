...
\hfill \emph{Morphology 2022-23, Edinburgh, Exercise 8}
\bigskip
...
\paragraph{Q2} Can you divide the second list, (\lastx), into two or three sub-classifications?

\paragraph{Q3} Can you propose a generalization for what the semantic difference between~(\blastx) and~(\lastx) amounts to?
