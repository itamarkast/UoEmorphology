...
What allomorphy is happening in these examples? Which morpheme is being \textbf{conditioned} (or \textbf{triggered}) by which element? Try and identify the same pattern that holds in all cases. % phonological, inward-looking
