...
For deriving *AAB and many other *ABA phenomena outwith adjectival suppletion, see the additional readings.
 
\paragraph{Further reading:} \cite{bobaljik12,bobaljik15ar}, \cite{smithetal16supplet}, \cite{mueller20}, and the articles in \cite{cahavanden17}.
...
Here's another example with its associated readings (or rather, the situations that can be plausibly expressed using this sentence):
