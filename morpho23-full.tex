...
We started by seeing whether we can come up with a definition of ``word'' that's consistent across all its uses: in writing (orthography), lexicography, syntax, semantics, phonology and so on. We concluded that there was none, but we were happy to talk about morphemes.
...
Until I incorporate these discussion into this set of lecture notes, the summaries can be found \href{https://uoe-my.sharepoint.com/:w:/g/personal/ikastner_ed_ac_uk/EbjHH_7rci5AoL0msG6mBJcBEg3YWsLaQ7gqXQjV69VERw}{at this link} (or via Learn).
