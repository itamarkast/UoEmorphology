...
\hfill \emph{Morphology 2023-24, Edinburgh, Exercise 3}
\bigskip
...
Draw a syntactic tree for~(\lastx a), based on whatever you've learned about syntax at this point. It doesn't need to be too fancy - we don't need any movement, for example, or very elaborate labels for different nodes; just an idea of what the different heads or phrases are and where they originate more or less.
...
Now let's do the same thing for Latin: first see how affixes are arranged. How does the order in Latin compare with the order in English?
\pex
    \a \begingl
        \gla am-\=a-ve-ra-m//
